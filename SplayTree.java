...
public class SplayTree<AnyType extends Comparable<? super AnyType>> {
     ...
     * (uses two passes), but has correct amortized behavior. A good alternative is
     * to first call find with parameter smaller than any item in the tree, then
     * call findMin.
     * 
     ...
     * (uses two passes), but has correct amortized behavior. A good alternative is
     * to first call find with parameter larger than any item in the tree, then call
     * findMax.
     * 
    ...
    /**
     * Internal method to perform a top-down splay. The last accessed node becomes
     * the new root.
     * 
