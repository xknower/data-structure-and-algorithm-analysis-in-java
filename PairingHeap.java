...
public class PairingHeap<AnyType extends Comparable<? super AnyType>> {
    /**
     * The Position interface represents a type that can be used for the decreaseKey
     * operation.
     */
     ...
     * @param newVal the new value, which must be smaller than the currently stored
     *               value.
     ...
     * 
     * @param first  root of tree 1, which may not be null. first.nextSibling MUST
     *               be null on entry.
