...
class CuckooHashTableClassicTest {
    ...
    public static void main(String[] args) {
        ...
        /*
         * Scanner scan = null; Set<String> words = new HashSet<>( );
         * 
         * try { scan = new Scanner( new FileReader( "dict.txt" ) ); String oneLine =
         * null; while( scan.hasNextLine( ) ) { words.add( oneLine = scan.nextLine( ) );
         * H.insert( oneLine ); }
         * 
         * if( words.size( ) != H.size( ) ) System.out.println( "OOPS!!! SIZE MISMATCH "
         * + words.size( ) + " " + H.size( ) );
         * 
         * for( String s : words ) if( !H.contains( s ) ) System.out.println(
         * "OOPS!! COULDN'T FIND " + s );
         * 
         * System.out.println( "H size is: " + H.size( ) ); System.out.println(
         * "Array size is: " + H.capacity( ) ); } catch( IOException e ) { } finally {
