...
public class Fig10_46 {
    ...
    /**
     * Compute optimal ordering of matrix multiplication. c contains the number of
     * columns for each of the n matrices. c[ 0 ] is the number of rows in matrix 1.
     * The minimum number of multiplications is left in m[ 1 ][ n ]. Actual ordering
     * is computed via another procedure using lastChange. m and lastChange are
     * indexed starting at 1, instead of 0. Note: Entries below main diagonals of m
